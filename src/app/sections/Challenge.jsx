  ...
  return (
    <section className="section" id="challenge">
      ...
      <p className="mb-4">
        ...
        analysis and communication. We will provide a starter kit and evaluation
        setup to support participants. More details—including datasets,
        templates, and submission instructions—will be released soon.
      </p>
      <img
        src="/challenge_new.png"
        alt="Challenge"
